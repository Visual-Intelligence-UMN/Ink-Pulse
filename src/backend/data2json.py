...
def get_data(session_id):
    json_path = os.path.join(os.path.dirname(os.getcwd()), "public", "chi2022-coauthor-v1.0/coauthor-json")
    for session in session_id:
        extracted_data = {'init_text': [], 'init_time': [], 'json': [], 'text': [], 'info': [], 'end_time': []}
        file_path = os.path.join(os.path.dirname(os.getcwd()), "public", "chi2022-coauthor-v1.0/coauthor-v1.0")
        actual_session = session['session_id']+'.jsonl'
        new_file_path = os.path.join(file_path, actual_session)
...
if __name__ == '__main__':
    json_path = os.path.join(os.path.dirname(os.getcwd()), "public", "fine.json")
