...
def convert_format(dataset_name):
    note_dir = os.path.join(static_dir, "dataset", f"{dataset_name}", "overall_sem_score.json")
    ...
    save_path = os.path.join(static_dir, "dataset", f"{dataset_name}", "overall_sem_score_summary.json")
...
def main(dataset_name):
    ...
    save_path = os.path.join(static_dir, "dataset", f"{dataset_name}", "overall_sem_score.json")
    with open(save_path, "w", encoding="utf-8") as f:
